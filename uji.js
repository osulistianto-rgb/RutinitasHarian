...
async function jalankan() {
  ...
  periksa('ikon terhubung', indeks.includes('ikon/ikon-192.png'));
  try {
  ...
  for (const f of ['manifest.webmanifest', 'sw.js', 'ikon/ikon-192.png', 'ikon/ikon-512.png',
                   'ikon/ikon-maskable-512.png', 'ikon/apple-touch-icon.png', '.nojekyll']) {
